                        ...
                        <div className='dialog-content'>
                            ...
                            <section>
                                {isRecording ? (
                                    ...
                                    <video ref={videoRef} src={recordedVideoUrl} controls /> // controls so we can move them around
                                ) : (
                                ...
                                {recordedVideoUrl && (
                                    <>
                                        <button onClick={recordAgain} className='record-again'>
                                            ...
                                            <button onClick={goToRecord} className='record-upload'>
